...
<div class="bottom_navigate">
    <ul class="breadcrumb">
        ...
        <li><a href="${pageContext.request.contextPath}/home/categories/${category.id}">${category.categoryName}</a></li>
...
<div class="main">
    ...
    <div class="myarticle">
        <c:forEach items="${category.articles}" var="art" varStatus="st">
