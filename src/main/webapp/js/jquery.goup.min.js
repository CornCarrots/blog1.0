...
(function (a) {
    ...
    function c(d, e) {
        var f = !0;
        d.on('click', function () {
            !0 == f && (f = !1, a('html, body').animate({scrollTop: 0}, e, function () {
                f = !0
            }))
        })
    }
    ...
    a.goup = function (d) {
        ...
        var g = a('body'), h = a(window), i = a('<div>');
        ...
        if (k.bottom = e.bottomOffset, k[e.location] = e.locationOffset, k['border-radius'] = e.containerRadius, i.css(k), !e.titleAsText) i.attr('title', e.title); else {
            var l = a('<div>');
            ...
            var m = parseInt(l.height()) + 10, n = parseInt(i.css('bottom'));
            i.css('bottom', m + n)
        }
        var p = 0.25 * e.containerSize, q = {
            width: 0,
            height: 0,
            margin: '0 auto',
